                            ...
                            <div class="card-body">
                                ...
                                <table>
                                    <p class="m-2 p-2 rounded bg-primary text-white" data-bs-toggle="collapse" data-bs-target="#Address">&#187; Address</p>
                                        <div id="Address" class="collapse rounded pl-4" role="presentation">
                                    ...
                                    <p class="m-2 p-2 rounded bg-primary text-white" data-bs-toggle="collapse" data-bs-target="#Education">&#187; Education</p>
                                        <div id="Education" class="collapse rounded pl-4" role="presentation">
                                    ...
                                    <p class="m-2 p-2 rounded bg-primary text-white" data-bs-toggle="collapse" data-bs-target="#Examination">&#187; Examination</p>
                                        <div id="Examination" class="collapse rounded pl-4" role="presentation">
                                    ...
                                    <p class="m-2 p-2 rounded bg-primary text-white" data-bs-toggle="collapse" data-bs-target="#LanguageDialect">&#187; Language/Dialect</p>
                                        <div id="LanguageDialect" class="collapse rounded pl-4" role="presentation">
                                    ...
                                    <p class="m-2 p-2 rounded bg-primary text-white" data-bs-toggle="collapse" data-bs-target="#CesStatus">&#187; Ces Status</p>
                                        <div id="CesStatus" class="collapse rounded pl-4" role="presentation">
                                    ...
                                    <p class="m-2 p-2 rounded bg-primary text-white" data-bs-toggle="collapse" data-bs-target="#Expertise">&#187; Expertise</p>
                                        <div id="Expertise" class="collapse rounded pl-4" role="presentation">
                                    ...
                                    <p class="m-2 p-2 rounded bg-primary text-white" data-bs-toggle="collapse" data-bs-target="#CaseRecords">&#187; Case Records</p>
                                        <div id="CaseRecords" class="collapse rounded pl-4" role="presentation">
                                    ...
                                    <p class="m-2 p-2 rounded bg-primary text-white" data-bs-toggle="collapse" data-bs-target="#Location">&#187; Location</p>
                                        <div id="Location" class="collapse rounded pl-4" role="presentation">
                            ...
                            <div id="AddressRecords" class="collapse tabcontent"  data-bs-parent="#accordion">
                                <div class="panel-body">
                                    <div class="card-body bg-white">
                                        ...
                                        <form class="user" id="city_municipality" method="POST" action="javascript:void(0);" onsubmit="submitForm('{{ env('APP_URL') }}admin/201-library/city-municipality/add', 'city_municipality', `Add`, `None`, `None`, `Yes`, `None` )">
                                            @csrf
                                            <!-- The Modal -->
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <label class="form-label ml-2 mb-0">Degree</label>
                            ...
                            <div class="panel-body">
                                <div class="card-body bg-white">
                                    ...
                                    <!-- start Course Major - Education modal -->
                                        ...
                                        <form class="user" id="course_majorID" method="POST" action="javascript:void(0);" onsubmit="submitForm('{{ env('APP_URL') }}admin/201-library/course-major/add', 'course_majorID', `Add`, `None`, `None`, `Yes`, `None` )">
                                            @csrf
                                            <!-- The Modal -->
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="form-label ml-2 mb-0">Course Major</label>
                            ...
                            <div class="panel-body">
                                <div class="card-body bg-white">
                                    <div>
                                        ...
                                        <form class="user" id="schoolID" method="POST" action="javascript:void(0);" onsubmit="submitForm('{{ env('APP_URL') }}admin/201-library/school/add', 'schoolID', `Add`, `None`, `None`, `Yes`, `None` )">
                                            @csrf
                                            <!-- The Modal -->
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="form-label ml-2 mb-0">School</label>
