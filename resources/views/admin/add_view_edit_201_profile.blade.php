...
<div class="container-fluid @if (str_contains(Request::url(),'profile/view')) row @endif">
    <!-- Main content -->
    ...
    <section class="content @if (str_contains(Request::url(),'profile/view')) @if(Auth::user()->role == 'User') ml-2 col @else col-md-9 @endif @endif">
        @if (str_contains(Request::url(),'profile/view'))
            ...
            <script>setPageTitle('View 201 Profile');</script>
        @else
            <script>setPageTitle('Create 201 Profile');</script>
        @endif
            ...
            <div class="row">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link active" id="person-data-tab" data-bs-toggle="tab" href="#person-data" role="tab" aria-controls="home" aria-selected="true">Personal Data</a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="family-profile-tab" data-bs-toggle="tab" href="#family-profile" role="tab" aria-controls="family-profile" aria-selected="false">Family Profile</a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="educational_attainment-tab" data-bs-toggle="tab" href="#educational_attainment" role="tab" aria-controls="educational_attainment" aria-selected="false">Educational Background / Attainment</a>
                    </li>
                    @endif
                    @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('Examinations Taken','Category Only') == 'true')

                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="examinations_taken-tab" data-bs-toggle="tab" href="#examinations_taken" role="tab" aria-controls="examinations_taken" aria-selected="false">Examinations Taken</a>
                    </li>
                    @endif
                    @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('Language Dialects','Category Only') == 'true')

                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="languages_dialects-tab" data-bs-toggle="tab" href="#languages_dialects" role="tab" aria-controls="languages_dialects" aria-selected="false">Languages Dialects</a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="eligibility_and_rank_tracker-tab" data-bs-toggle="tab" href="#eligibility_and_rank_tracker" role="tab" aria-controls="eligibility_and_rank_tracker" aria-selected="false">Eligibility and Rank Tracker</a>
                    </li>
                    @endif
                    @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('Record of CESPES Ratings','Category Only') == 'true')

                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="record_of_cespes_rating_hr-tab" data-bs-toggle="tab" href="#record_of_cespes_rating_hr" role="tab" aria-controls="record_of_cespes_rating_hr" aria-selected="false">Record of Cespes Ratings</a>
                    </li>
                    @endif
                    @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('Work Experience','Category Only') == 'true')

                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="work_experience-tab" data-bs-toggle="tab" href="#work_experience" role="tab" aria-controls="work_experience" aria-selected="false">Work Experience</a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="field_expertise-tab" data-bs-toggle="tab" href="#field_expertise" role="tab" aria-controls="field_expertise" aria-selected="false">Field Expertise</a>
                    </li>
                    @endif
                    @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('CES Trainings','Category Only') == 'true')

                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="ces_trainings-tab" data-bs-toggle="tab" href="#ces_trainings" role="tab" aria-controls="ces_trainings" aria-selected="false">Ces Trainings</a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="other_management_trainings-tab" data-bs-toggle="tab" href="#other_management_trainings" role="tab" aria-controls="other_management_trainings" aria-selected="false">Other Trainings</a>
                    </li>
                    @endif
                    @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('Research and Studies','Category Only') == 'true')

                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="research_and_studies-tab" data-bs-toggle="tab" href="#research_and_studies" role="tab" aria-controls="research_and_studies" aria-selected="false">Research And Studies</a>
                    </li>
                    @endif
                    @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('Scholarships Received','Category Only') == 'true')

                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="scholarships-tab" data-bs-toggle="tab" href="#scholarships" role="tab" aria-controls="scholarships" aria-selected="false">Scholarships</a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="major_civic_and_professional_affiliations-tab" data-bs-toggle="tab" href="#major_civic_and_professional_affiliations" role="tab" aria-controls="major_civic_and_professional_affiliations" aria-selected="false">Major Civic and Professional Affiliations</a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="award_and_citations-tab" data-bs-toggle="tab" href="#award_and_citations" role="tab" aria-controls="award_and_citations" aria-selected="false">Award And Citations</a>
                    </li>
                    @endif
                    @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('Case Records','Category Only') == 'true')

                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="case_records-tab" data-bs-toggle="tab" href="#case_records" role="tab" aria-controls="case_records" aria-selected="false">Case Records</a>
                    </li>
                    @endif
                    @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('Health Record','Category Only') == 'true')

                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="health_records-tab" data-bs-toggle="tab" href="#health_records" role="tab" aria-controls="health_records" aria-selected="false">Health Records</a>
                    </li>
                    @endif
                    @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('Attached PDF Files','Category Only') == 'true')

                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="pdf_files-tab" data-bs-toggle="tab" href="#pdf_files" role="tab" aria-controls="pdf_files" aria-selected="false">PDF Files</a>
                    </li>
                    @endif
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="person-data" role="tabpanel" aria-labelledby="person-data-tab">
                            ...
                            @endif
                                ...
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">PERSONAL DATA</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">CES No.<span class="text-danger">*</span></label>
                                            <input type="number" id="cesno" name="cesno" class="form-control mb-3" @if (str_contains(Request::url(),'profile/add')) value="{{ $latestCesNo }}" @endif readonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Record Status<span class="text-danger">*</span></label>
                                            <select name="status" class="form-control w-100 mb-3" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Solo Parent?<span class="text-danger">*</span></label>
                                            <select name="sp" aria-aria-controls='example' id="sppd_ip_TxtB" class="w-100 form-control mb-3" required>
                                                <option value="">Please Select</option>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Member of Indigenous Group?<span class="text-danger">*</span></label>
                                            <select name="moig" aria-aria-controls='example' id="moig_TxtB" class="w-100 form-control mb-3" required>
                                                <option value="">Please Select</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <div class="col-md-3 ml-3">
                                            <input class="form-check-input" id="pwd_CheckB" name="pwd_CheckB" type="checkbox" value="Yes">
                                            <label class="form-label ml-2 mb-0">is PWD?</label>
                                            <select name="pwd" aria-aria-controls='example' id="pwd_TxtB" class="w-100 form-control mb-3" disabled>
                                                <option value="">Please Select</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Title<span class="text-danger">*</span></label>
                                            <select name="title" class="form-control w-100 mb-3" required>
                                                <option value="">Please Select</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">GSIS ID No.<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">PAG-IBIG ID No.<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">PHILHEALTH ID No.<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">SSS ID No.</label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">TIN ID No.</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0" >Citizenship<span class="text-danger">*</span></label>
                                            <select name="citizenship" class="form-control w-100 citizenShip mb-3" required>
                                                <option value="">Please Select</option>
                                        ...
                                        <div class="col-md-8">
                                        <label class="form-label ml-2 mb-0" >If Holder Dual Citizenship By Birth, By Naturalization</label>
                                            <input type="text" name="d_citizenship" class="form-control w-100 mb-3" id="inputcitizenShip" placeholder="Please indicate the Country" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Lastname<span class="text-danger">*</span></label>
                                            <input type="text" id="lastname" name="lastname" style="text-transform:capitalize" class="form-control w-100 mb-3" onchange="validate201Profile()" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Firstname<span class="text-danger">*</span></label>
                                            <input type="text" id="firstname" name="firstname" style="text-transform:capitalize" class="form-control w-100 mb-3" onchange="validate201Profile()" required>
                                        </div>
                                        <div class="col-md-5">
                                            <label class="form-label ml-2 mb-0">Middlename<span class="text-danger">*</span></label>
                                            <input type="text" minlength="2" id="middlename" name="middlename" style="text-transform:capitalize" class="Mn noNotallow form-control w-100 mb-3" onchange="validate201Profile()" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label ml-2 mb-0">M.I<span class="text-danger">*</span></label>
                                            <input type="text" name="mi" style="text-transform:capitalize" class="Mi form-control w-100 mb-3" readonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Name Extension</label>
                                            <select name="ne" class="form-control w-100 mb-3">
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-label ml-2 mb-0">Nickname</label>
                                            <input type="text" name="nickname" style="text-transform:capitalize" class="form-control w-100 mb-3">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label ml-2 mb-0">Birthdate<span class="text-danger">*</span></label>
                                            <input type="date" id="birthdate" name="birthdate" class="mydob form-control w-100 mb-3" onchange="validate201Profile()" required>
                                        </div>
                                        <div class="col-md-2">
                                        <label class="form-label ml-2 mb-0">Age<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="birth_place" style="text-transform:capitalize" class="form-control w-100 mb-3">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label ml-2 mb-0">Gender By Birth<span class="text-danger">*</span></label>
                                            <select name="gender" class="form-control w-100 mb-3" required>
                                                <option value="">Please Select</option>
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-label ml-2 mb-0">Civil Status<span class="text-danger">*</span></label>
                                            <select name="civil_status" aria-aria-controls='example' class="w-100 form-control  mb-3" required>
                                                <option value="">Please Select</option>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Religion<span class="text-danger">*</span></label>
                                            <input type="text" name="religion" style="text-transform:capitalize" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label ml-2 mb-0">Height (in meters)</label>
                                            <input type="text" name="height" class="form-control w-100 mb-3" placeholder="In Meters">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label ml-2 mb-0">Weight (in kilograms)</label>
                                            <input type="text" name="weight" class="form-control w-100 mb-3" placeholder="In Kilograms">
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">HOME/PERMANENT ADDRESS</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Brgy. / District<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">City / Municipality<span class="text-danger">*</span></label>
                                            <input type="text" name="cm_pa" style="text-transform:capitalize" class="form-control w-100 mb-3" required>
                                            <!-- <select name="cm_pa" aria-aria-controls='example' style="text-transform:capitalize" class="w-100 form-control mb-3">
                                                <option value="">Please Select</option>
                                                <option value=""></option>
                                                <option value=""></option>
                                                <option value=""></option>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Zip Code<span class="text-danger">*</span></label>
                                            <input type="number" name="zc_pa" class="form-control w-100 mb-3" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">MAILING ADDRESS</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">City / Municipality<span class="text-danger">*</span></label>
                                            <input type="text" name="cm_ma" style="text-transform:capitalize" class="form-control w-100 mb-3" required>
                                            <!-- <select name="cm_ma" aria-aria-controls='example' style="text-transform:capitalize" class="w-100 form-control mb-3">
                                                <option value="">Please Select</option>
                                                <option value=""></option>
                                                <option value=""></option>
                                                <option value=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        @if (str_contains(Request::url(),'profile/view'))
                                            ...
                                            <input id="personal_data_submit" type="submit" class="btn btn-secondary mb-1" value="Edit Record" hidden disabled>
                                            @endif
                                        @else
                                            @if(App\Http\Controllers\RolesController::validateUserExecutive201RoleAccess('Personal Data','Add') == 'true')

                                            <input id="personal_data_submit" type="submit" class="btn btn-primary mb-1" value="Add Record" >
                                            @endif
                                        @endif
                        ...
                        <div class="tab-pane fade" id="family-profile" role="tabpanel" aria-labelledby="family-profile-tab">
                            <form class="user" id="spouse_records_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/spouse-records/add`, `spouse_records_form`, `Add`, `updateSpouseRecordsTable`, `resetSpouseRecordsForm`, `spouse_records_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">SPOUSE NAME</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                            ...
                            @endif
                                ...
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">FATHERS NAME</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                ...
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">MOTHERS MAIDEN NAME</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                            ...
                            <form class="user" id="children_record_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/children-records/add`, `children_record_form`, `Add`, `updateChildrenRecordsTable`, `resetChildrenRecordsForm`, `children_record_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">CHILDRENS RECORD</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="educational_attainment" role="tabpanel" aria-labelledby="educational_attainment-tab">
                            <form class="user" id="educational_attainment_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/educational-attainment/add`, `educational_attainment_form`, `Add`, `updateEducationalAttainmentTable`, `resetEducationalAttainmentForm`, `educational_attainment_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">HISTORICAL RECORD OF EDUCATION BACKGROUND / ATTAINMENT</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <label class="form-label ml-2 mb-0">Level<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-label ml-2 mb-0">School<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-label ml-2 mb-0">Degree<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-label ml-2 mb-0">Year Graduated<span class="text-danger">*</span></label>
                                            <input type="year" name="date_grad_ea" id="onlyYear" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Major / Specialization<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">School Type / Status<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Period of Attendance From<span class="text-danger">*</span></label>
                                            <input type="date" name="date_f_ea" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Period of Attendance To<span class="text-danger">*</span></label>
                                            <input type="date" name="date_t_ea" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Heighest Level / Unit Earned<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="examinations_taken" role="tabpanel" aria-labelledby="examinations_taken-tab">
                            <form class="user" id="examinations_taken_historical_record_of_examinations_taken_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/examination-taken/add`, `examinations_taken_historical_record_of_examinations_taken_form`, `Add`, `updateExaminationsTakenTable`, `resetExaminationsTakenForm`, `examinations_taken_historical_record_of_examinations_taken_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">HISTORICAL RECORDS OF EXAMINATIONS TAKEN</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">Type of Examination<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Rating<span class="text-danger">*</span></label>
                                            <input type="text" name="rating_et" class="form-control mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Date of Examination<span class="text-danger">*</span></label>
                                            <input type="date" name="doe_et" class="form-control mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Place of Examination<span class="text-danger">*</span></label>
                            ...
                            <form class="user" id="examinations_taken_license_details_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/license-details/add`, `examinations_taken_license_details_form`, `Add`, `updateLicenseDetailsTable`, `resetLicenseDetailsForm`, `examinations_taken_license_details_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">LICENSE DETAILS</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row g-2">
                                        <div class="col-md-4">
                                            ...
                                            <label class="form-label ml-2 mb-0">License Number<span class="text-danger">*</span></label>
                                            <input type="text" name="ld_ln_et" class="form-control mb-3" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Date Acquired<span class="text-danger">*</span></label>
                                            <input type="date" name="ld_da_et" class="form-control mb-3" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Date of Validity<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="languages_dialects" role="tabpanel" aria-labelledby="languages_dialects-tab">
                            <form class="user" id="languages_dialects_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/languages-dialects/add`, `languages_dialects_form`, `Add`, `updateLanguagesDialectsTable`, `resetLanguagesDialectsForm`, `languages_dialects_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                        <h4 class="pl-3 py-2 text-warning font-weight-bold">LANGUAGES / DIALECTS</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">Languages<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="eligibility_and_rank_tracker" role="tabpanel" aria-labelledby="eligibility_and_rank_tracker-tab">
                            <form class="user" id="ceswe_hr_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/ces-we/add`, `ceswe_hr_form`, `Add`, `updateCesWeTable`, `resetCesWeForm`, `ceswe_hr_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">CES WE ( HISTORICAL RECORD )</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">Examination Date<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Rating Definition<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Take No.<span class="text-danger">*</span></label>
                            ...
                            <form class="user" id="assessment_center_hr_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/assessment-center/add`, `assessment_center_hr_form`, `Add`, `updateAssessmentCenterTable`, `resetAssessmentCenterForm`, `assessment_center_hr_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">ASSESSMENT CENTER ( HISTORICAL RECORD )</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">AC No.<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control w-100 mb-3" name="an_achr_ces_we" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Assessment Date<span class="text-danger">*</span></label>
                            ...
                            <form class="user" id="validation_hr_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/validation-hr/add`, `validation_hr_form`, `Add`, `updateValidationHrTable`, `resetValidationHrForm`, `validation_hr_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">VALIDATION ( HISTORICAL RECORD )</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">Validation Date<span class="text-danger">*</span></label>
                                            <input type="date" class="form-control w-100 mb-3" name="vd_vhr_ces_we" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Type of Validation<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Result<span class="text-danger">*</span></label>
                            ...
                            <form class="user" id="board_interview_hr_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/board-interview/add`, `board_interview_hr_form`, `Add`, `updateBoardInterviewTable`, `resetBoardInterviewForm`, `board_interview_hr_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">BOARD INTERVIEW</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">Board Interview Date<span class="text-danger">*</span></label>
                            ...
                            <form class="user" id="ces_status_hr_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/ces-status/add`, `ces_status_hr_form`, `Add`, `updateCesStatusTable`, `resetCesStatusForm`, `ces_status_hr_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">CES STATUS</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">CES Status<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Acquired Thru<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Status Type<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <!-- <label class="form-label ml-2 mb-0">Appointing Authority<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Resolution No.<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="record_of_cespes_rating_hr" role="tabpanel" aria-labelledby="record_of_cespes_rating_hr-tab">
                            <form class="user" id="record_of_cespes_rating_hr_form" method="POST" enctype="multipart/form-data" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/record-of-cespes-ratings/add`, `record_of_cespes_rating_hr_form`, `Add`, `updateRecordOfCespesRatingsTable`, `resetRecordOfCespesRatingsForm`, `record_of_cespes_rating_hr_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">RECORD OF CESPES RATINGS</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">Date (From)<span class="text-danger">*</span></label>
                                            <input type="date" class="form-control w-100 mb-3" name="date_from_rocr" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Date (To)<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Status<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control w-100 mb-3" name="status_rocr" required>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label ml-2 mb-0">Remarks<span class="text-danger">*</span></label>
                                            <textarea class="form-control w-100 mb-3" style="text-transform:capitalize" name="remarks_rocr" id="" rows="4" required></textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Attached Certificate of Rating (PDF Format)<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="work_experience" role="tabpanel" aria-labelledby="work_experience-tab">
                            <form class="user" id="work_experience_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/work-experience/add`, `work_experience_form`, `Add`, `updateWorkExperienceTable`, `resetWorkExperienceForm`, `work_experience_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">WORK EXPERIENCE</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Position Title / Designation<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Monthly Salary<span class="text-danger">*</span></label>
                                            <input type="text" name="salary_from_work_experience" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Salary/Job/Pay Grade<span class="text-danger">*</span></label>
                                            <input type="text" name="salary_job_pay_grade_work_experience" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Status of Appointment<span class="text-danger">*</span></label>
                                            <input type="text" name="status_of_appointment_work_experience" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Government Service<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Department / Agency<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="field_expertise" role="tabpanel" aria-labelledby="field_expertise-tab">
                            <form class="user" id="field_expertise_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/field-expertise/add`, `field_expertise_form`, `Add`, `updateFieldExpertiseTable`, `resetFieldExpertiseForm`, `field_expertise_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">RECORDS OF FIELD OF EXPERTISE / SPECIALIZATION</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">Expertise<span class="text-danger">*</span></label>
                                            <input type="text" name="ec_field_expertise" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Field of Specialization<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="ces_trainings" role="tabpanel" aria-labelledby="ces_trainings-tab">
                            <form class="user" id="ces_trainings_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/ces-trainings/add`, `ces_trainings_form`, `Add`, `updateCesTrainingsTable`, `resetCesTrainingsForm`, `ces_trainings_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">HISTORICAL RECORD OF CES TRAININGS</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <label class="form-label ml-2 mb-0">Training Date (From)<span class="text-danger">*</span></label>
                                            <input type="date" name="date_f_ces_trainings" class="w-100 form-control mb-3" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Training Date (To)<span class="text-danger">*</span></label>
                                            <input type="date" name="date_t_ces_trainings" class="w-100 form-control mb-3" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Session Title / Program<span class="text-danger">*</span></label>
                                            <input type="text" name="s_title_ces_trainings" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Session No.<span class="text-danger">*</span></label>
                                            <input type="text" name="s_no_ces_trainings" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Training Category / Theme<span class="text-danger">*</span></label>
                                            <input type="text" name="training_category_ces_trainings" class="form-control w-100 mb-3" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Expertise / Field of Specialization<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Venue<span class="text-danger">*</span></label>
                                            <input type="text" name="venue_ces_trainings" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">No. of Training hours<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Resource Speaker<span class="text-danger">*</span></label>
                                            <input type="text" name="rs_ces_trainings" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Session Director<span class="text-danger">*</span></label>
                                            <input type="text" name="sd_ces_trainings" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Training Status<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="other_management_trainings" role="tabpanel" aria-labelledby="other_management_trainings-tab">
                            <form class="user" id="other_management_trainings_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/other-management-trainings/add`, `other_management_trainings_form`, `Add`, `updateOtherManagementTrainingsTable`, `resetOtherManagementTrainingsForm`, `other_management_trainings_form_submit`, `None`, `None`)">
                                ...
                                <div class="container-fuild m-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Training Title<span class="text-danger">*</span></label>
                                            <input type="text" name="title_traning_onat" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Training Category<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Sponsor / Training Provider<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">No. of Traning Hours<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="research_and_studies" role="tabpanel" aria-labelledby="research_and_studies-tab">
                            <form class="user" id="research_and_studies_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/research-and-studies/add`, `research_and_studies_form`, `Add`, `updateResearchAndStudiesTable`, `resetResearchAndStudiesForm`, `research_and_studies_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">RESEARCH AND STUDIES</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Research Title<span class="text-danger">*</span></label>
                                            <input type="text" name="title_ras" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Publisher<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="scholarships" role="tabpanel" aria-labelledby="scholarships-tab">
                            <form class="user" id="scholarships_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/scholarships/add`, `scholarships_form`, `Add`, `updateScholarshipsTable`, `resetScholarshipsForm`, `scholarships_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">SCHOLARSHIP RECEIVED</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label ml-2 mb-0">Scholar Type<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Sponsor<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="major_civic_and_professional_affiliations" role="tabpanel" aria-labelledby="major_civic_and_professional_affiliations-tab">
                            <form class="user" id="major_civic_and_professional_affiliations_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/major-civic-and-professional-affiliations/add`, `major_civic_and_professional_affiliations_form`, `Add`, `updateAffiliationsTable`, `resetAffiliationsForm`, `major_civic_and_professional_affiliations_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">MAJOR CIVIC AND PROFESSIONAL AFFILIATIONS</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Organization<span class="text-danger">*</span></label>
                                            <input type="text" name="organization_mcapa" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Position<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="award_and_citations" role="tabpanel" aria-labelledby="award_and_citations-tab">
                            <form class="user" id="award_and_citations_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/award-and-citations/add`, `award_and_citations_form`, `Add`, `updateAwardAndCitationsTable`, `resetAwardAndCitationsForm`, `award_and_citations_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">AWARD AND CITATIONS RECEIVED</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">Date<span class="text-danger">*</span></label>
                                            <input type="date" name="date_aac" class="w-100 form-control mb-3" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Title of Award<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="case_records" role="tabpanel" aria-labelledby="case_records-tab">
                            <form class="user" id="case_records_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/case-records/add`, `case_records_form`, `Add`, `updateCaseRecordsTable`, `resetCaseRecordsForm`, `case_records_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">CASE RECORDS</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">Parties<span class="text-danger">*</span></label>
                                            <input type="text" name="parties_case_records" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Offence<span class="text-danger">*</span></label>
                                            <input type="text" name="offence_case_records" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Nature of Offence<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Case Number<span class="text-danger">*</span></label>
                                            <input type="text" name="case_no_case_records" class="form-control w-100 mb-3" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Date Field<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Date of Finality<span class="text-danger">*</span></label>
                                            <input type="date" name="dof_case_records" class="form-control w-100 mb-3" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="form-label ml-2 mb-0">Decision<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="form-label ml-2 mb-0">Remarks<span class="text-danger">*</span></label>
                                            <textarea name="remarks_case_records" class="form-control w-100 rounded mb-3" style="text-transform:capitalize" rows="4" required></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col my-3">
                        ...
                        <div class="tab-pane fade" id="health_records" role="tabpanel" aria-labelledby="health_records-tab">
                            <form class="user" id="health_records_magna_carta_for_disabled_persons_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/health-records/add`, `health_records_magna_carta_for_disabled_persons_form`, `Add`, `updateHealthRecordsTable`, `resetHealthRecordsForm`, `health_records_magna_carta_for_disabled_persons_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">HEALTH RECORDS</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Blood Type<span class="text-danger">*</span></label>
                                            <input type="text" name="blood_type_hr" class="form-control w-100 mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0">Identifying Marks<span class="text-danger">*</span></label>
                            ...
                            <form class="user" id="health_records_historical_record_of_medical_condition_form" method="POST" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/historical-record-of-medical-condition/add`, `health_records_historical_record_of_medical_condition_form`, `Add`, `updateHistoricalRecordOfMedicalConditionTable`, `resetHistoricalRecordOfMedicalConditionForm`, `health_records_historical_record_of_medical_condition_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">HISTORICAL RECORD OF MEDICAL CONDTION</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                        <label class="form-label ml-2 mb-0">Medical Condition / Illness<span class="text-danger">*</span></label>
                                        <input type="text" name="mci_hronc" class="form-control w-100 mb-3" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="form-label ml-2 mb-0">Notes<span class="text-danger">*</span></label>
                                            <textarea name="notes_hronc" class="form-control w-100 rounded mb-3" style="text-transform:capitalize" rows="4" required></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col my-3">
                        ...
                        <div class="tab-pane fade" id="pdf_files" role="tabpanel" aria-labelledby="pdf_files-tab">
                            <form class="user" id="pdf_files_form" method="POST" enctype="multipart/form-data" action="javascript:void(0);" onsubmit="submitForm(`{{ env('APP_URL') }}api/v1/pdf-files/add`, `pdf_files_form`, `Add`, `updatePdfFilesTable`, `resetPdfFilesForm`, `pdf_files_form_submit`, `None`, `None`)">
                                @csrf
                                <div class="bg-primary">
                                    <h4 class="pl-3 py-2 text-warning font-weight-bold">PDF FILES</h4>
                                </div>
                                <div class="container-fuild m-3">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <label class="form-label ml-2 mb-0">Browse PDF Files<span class="text-danger">*</span></label>
                                            <input id="pdflink" name="pdflink" accept="application/pdf" type="file" onclick="validateFileSize(`pdflink`, 25)" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label ml-2 mb-0" for="validated">Validated?<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="form-label ml-2 mb-0">Remarks<span class="text-danger">*</span></label>
                                            <textarea id="remarks_pdf_files" name="remarks_pdf_files" class="form-control w-100 rounded mb-3" style="text-transform:capitalize" rows="4" required></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col my-3">
